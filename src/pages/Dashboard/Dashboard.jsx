...
export default function Dashboard() {
  ...
  }, [activeView, puedeVerTodos, selectedComercial, selectedTag, parseDateFilters]);
  ...
  // Cargar métricas cuando se activa el tab o cambian filtros
  useEffect(() => {
    if (activeView === 'metricas' && !loading && userEmail) {
      fetchMetricas();
    }
  }, [activeView, selectedComercial, selectedMes, selectedPeriodo, selectedDia, selectedTag, fetchMetricas]);
